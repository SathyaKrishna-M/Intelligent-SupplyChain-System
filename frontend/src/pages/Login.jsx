    ...
    <div className="min-h-screen bg-slate-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md flex flex-col items-center">
        ...
        <h2 className="mt-2 text-center text-3xl font-extrabold text-slate-900 tracking-tight">
          Supply<span className="text-blue-600">Chain</span> OS
        </h2>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-slate-500">New to the system?</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <Link
                to="/register"
                className="w-full flex justify-center py-2.5 px-4 border border-slate-300 rounded-lg shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 focus:outline-none transition-colors"
              >
                Register an account
              </Link>
            </div>
